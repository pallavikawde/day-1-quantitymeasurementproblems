...
public enum Unit {
    ...
    FEET(1.0),  FEET_TO_INCH(12.0), INCH(1.0),

    YARD_TO_INCH(36.0), CENTIMETER_TO_INCH(0.3937007874015748),

    LITRE(1.0), GALLON_TO_LITRE(3.78),

    MILLILITER_TO_LITRE(0.001), KILOGRAM(1.0),

    GRAMS_TO_KILOGRAM(1.0 / 1000), TONNE_TO_KILOGRAM(1000),

    CELSIUS(1.8), FAHRENHEIT(1.8);
